  ...
  test(
    ...
    new context {
      ...
      assert(logger.infos.map(_.message) === List(
        ...
        "Info:Reading zip entry sx9090.csv...",
        "Info:Reading from 1 CSV files in {} took {}.",
        "Info:Second pass processed 42874 DPAs, 5863 LPIs.",
      ...
      assert(addressesProduced(0) === DbAddress("GB10013050866", List("9 Princesshay"), "Exeter", "EX1 1GE", "GB-ENG"))
      ...
      assert(addressesProduced(3) === DbAddress("GB10091471879", List("Flat 1","2 Queens Crescent"), "Exeter", "EX4 6AY", "GB-ENG")) //TODO This is not really correct
      ...
      assert(addressesProduced(9) === DbAddress("GB10091472481", List("Unit 1", "25 Manor Road"), "Exeter", "EX4 1BU", "GB-ENG"))
      ...
      assert(addressesProduced(10) === DbAddress("GB10091471884", List("Room 4 Baring House", "6 Baring Crescent"), "Exeter", "EX1 1TL", "GB-ENG"))
      ...
      assert(addressesProduced(16) === DbAddress("GB10091471886", List("Office 7 Baring House", "6 Baring Crescent"), "Exeter", "EX1 1TL", "GB-ENG"))
      ...
      assert(addressesProduced(20) === DbAddress("GB10023117655", List("School Kitchen St Michaels Ce Primary School", "South Lawn Terrace"), "Exeter", "EX1 2SN", "GB-ENG"))
      ...
      assert(addressesProduced(21) === DbAddress("GB10023119039", List("Annexe" , "12 St Leonards Road"), "Exeter", "EX2 4LA", "GB-ENG"))
    }
  }
