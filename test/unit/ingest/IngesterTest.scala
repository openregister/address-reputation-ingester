...
class IngesterTest extends FunSuite with MockitoSugar {
  ...
  test(
    ...
    new context {
      ...
      assert(addressesProduced("GB100040230002") === DbAddress("GB100040230002",
        List("6 Prospect Gardens"), Some("Exeter"), "EX4 6TA", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), Some(3), Some(1), None, None, Some("50.730385,-3.5160181")))
      ...
      assert(addressesProduced("GB10023118140") === DbAddress("GB10023118140",
        List("3 Terracina Court", "Haven Road"), Some("Exeter"), "EX2 8DP", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), Some(2), Some(1), None, None, Some("50.7166511,-3.5302985")))
      ...
      assert(addressesProduced("GB10013050866") === DbAddress("GB10013050866",
        List("9 Princesshay"), Some("Exeter"), "EX1 1GE", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), None, Some(8), Some(8), None, Some("50.7243583,-3.5277673")))
      ...
      assert(addressesProduced("GB10091471879") === DbAddress("GB10091471879",
        List("Flat 1", "2 Queens Crescent"), Some("Exeter"), "EX4 6AY", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), Some(2), Some(1), Some(8), None, Some("50.7285207,-3.5249454"))) //TODO This is not really correct
      ...
      assert(addressesProduced("GB10091472481") === DbAddress("GB10091472481",
        List("Unit 1", "25 Manor Road"), Some("Exeter"), "EX4 1BU", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), Some(2), Some(1), Some(8), None, Some("50.7190093,-3.5447065")))
      ...
      assert(addressesProduced("GB10091471884") === DbAddress("GB10091471884",
        List("Room 4, Baring House", "6 Baring Crescent"), Some("Exeter"), "EX1 1TL", Some("GB-ENG"), Some("UK"),
        Some(1110), Some("en"), Some(2), Some(1), Some(8), None, Some("50.7223255,-3.5140436")))
      ...
      assert(addressesProduced("GB10091471886") === DbAddress("GB10091471886",
        List("Office 7, Baring House", "6 Baring Crescent"), Some("Exeter"), "EX1 1TL", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), Some(2), Some(1), Some(8), None, Some("50.7223255,-3.5140436")))
      ...
      assert(addressesProduced("GB10023117655") === DbAddress("GB10023117655",
        List("School Kitchen, St Michaels Ce Primary School", "South Lawn Terrace"), Some("Exeter"), "EX1 2SN", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), Some(2), Some(1), Some(8), None, Some("50.7232751,-3.5043915")))
      ...
      assert(addressesProduced("GB10023119039") === DbAddress("GB10023119039",
        List("Annexe", "12 St Leonards Road"), Some("Exeter"), "EX2 4LA", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), Some(2), Some(1), Some(8), None, Some("50.7204951,-3.5199347")))
      ...
      assert(addressesProduced("GB100040210161") === DbAddress("GB100040210161",
        List("1 Curlew Way"), Some("Exeter"), "EX4 4SW", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), Some(2), Some(1), None, None, Some("50.740384,-3.5244338")))
      ...
      assert(addressesProduced("GB10023122465") === DbAddress("GB10023122465",
        List("15 Gate Reach"), Some("Exeter"), "EX2 6GA", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), Some(2), Some(1), None, None, Some("50.7056301,-3.5095205")))
      ...
      assert(addressesProduced("GB10023119082") === DbAddress("GB10023119082",
        List("Flat G.01 Block G, Birks Hall", "New North Road"), Some("Exeter"), "EX4 4FT", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), Some(2), Some(1), None, None, Some("50.7368747,-3.5427382")))
      ...
      assert(addressesProduced("GB10092760043") === DbAddress("GB10092760043",
        ...
        Some("en"), None, Some(1), None, None, Some("50.7263105,-3.5222624")))
      ...
      assert(addressesProduced("GB10013038314") === DbAddress("GB10013038314",
        List("Unit 25, Exeter Business Centre", "39 Marsh Green Road West", "Marsh Barton Trading Estate"), Some("Exeter"), "EX2 8PN", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), Some(2), Some(1), None, None, Some("50.7058084,-3.5307391")))
    }
  }
  ...
  test(
    ...
    new context {
      ...
      assert(addressesProduced("GB100040230002") === DbAddress("GB100040230002",
        List("6 Prospect Gardens"), Some("Exeter"), "EX4 6TA", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), Some(3), Some(1), Some(8), None, Some("50.730385,-3.5160181")))
      ...
      assert(addressesProduced("GB10023118140") === DbAddress("GB10023118140",
        List("3 Terracina Court", "Haven Road"), Some("Exeter"), "EX2 8DP", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), Some(2), Some(1), Some(8), None, Some("50.7166511,-3.5302985")))
      ...
      assert(addressesProduced("GB10091471879") === DbAddress("GB10091471879",
        List("Flat 1", "2 Queens Crescent"), Some("Exeter"), "EX4 6AY", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), Some(2), Some(1), Some(8), None, Some("50.7285207,-3.5249454")))
      ...
      // 24,"I",55909,10091471884,"1110L000174409","ENG",1,2015-11-04,,2016-02-10,2015-11-02,,"",,"","ROOM 4",6,"",,"","BARING HOUSE",14200047,"1","","",""
      assert(addressesProduced("GB10091471884") === DbAddress("GB10091471884",
        List("Room 4, Baring House", "6 Baring Crescent"), Some("Exeter"), "EX1 1TL", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), Some(2), Some(1), Some(8), None, Some("50.7223255,-3.5140436")))
      ...
      assert(addressesProduced("GB100040210161") === DbAddress("GB100040210161",
        List("1 Curlew Way"), Some("Exeter"), "EX4 4SW", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), Some(2), Some(1), Some(8), None, Some("50.740384,-3.5244338")))
      ...
      assert(addressesProduced("GB10023122465") === DbAddress("GB10023122465",
        List("15 Gate Reach"), Some("Exeter"), "EX2 6GA", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), Some(2), Some(1), Some(8), None, Some("50.7056301,-3.5095205")))
      ...
      // 28,"I",109427,10023119082,52172489,"","","FLAT G.01 BLOCK G","BIRKS HALL",,"","NEW NORTH ROAD","","","EXETER","EX4 4FT","S","1A","","","","","","",2016-01-18,2012-04-23,,2016-02-10,2012-03-19
      assert(addressesProduced("GB10023119082") === DbAddress("GB10023119082",
        List("Flat G.01 Block G, Birks Halls", "New North Road"), Some("Exeter"), "EX4 4FT", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), Some(2), Some(1), Some(8), None, Some("50.7368747,-3.5427382")))
      ...
      // 28,"I",144222,10092760043,52960003,"FLY BE","","","",,"","","","","EXETER","EX1 9UL","L","1A","","","","","","795",2016-01-18,2014-09-12,,2016-02-10,2012-12-27
      assert(addressesProduced("GB10092760043") === DbAddress("GB10092760043",
        List("Po Box 795, Summerland Gate", "Belgrave Road"), Some("Exeter"), "EX1 9UL", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), None, Some(1), Some(8), None, Some("50.7263105,-3.5222624")))
      ...
      // 28,"I",117777,10013038314,8764842,"ENVIRONMENTAL INSTRUMENTS","","UNIT 25","EXETER BUSINESS CENTRE",39,"","MARSH GREEN ROAD WEST","","MARSH BARTON TRADING ESTATE","EXETER","EX2 8PN","S","4L","","","","","","",2016-01-18,2012-04-23,,2016-02-10,2012-03-19
      assert(addressesProduced("GB10013038314") === DbAddress("GB10013038314",
        List("Unit 25, Exeter Business Centre", "39 Marsh Green Road West"), Some("Exeter"), "EX2 8PN", Some("GB-ENG"), Some("UK"), Some(1110),
        Some("en"), Some(2), Some(1), Some(8), None, Some("50.7058084,-3.5307391")))
  ...
  test(
    ...
    new context {
      ...
      val blpu3 = Blpu(Some(2L), "FX1 1CC", '1', '2', 'E', 7655, "0,0")
  ...
  test(
    ...
    new context {
      ...
      val blpu2a = Blpu(None, "FX1 1BB", '1', '2', 'E', 1111, "0,0")
      val blpu2b = Blpu(None, "FX1 1BB", '1', '2', 'E', 2222, "0,0")
      val blpu2c = Blpu(None, "FX1 1BB", '1', '2', 'E', 7655, "0,0")
