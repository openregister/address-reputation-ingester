...
class IngesterTest extends FunSuite with MockitoSugar {
  ...
  test(
    ...
    new context {
      ...
      assert(addressesProduced(0) === DbAddress("GB10013050866", List("9 Princesshay"), Some("Exeter"), "EX1 1GE", Some("GB-ENG"), None))
      ...
      assert(addressesProduced(3) === DbAddress("GB10091471879", List("Flat 1","2 Queens Crescent"), Some("Exeter"), "EX4 6AY", Some("GB-ENG"), None)) //TODO This is not really correct
      ...
      assert(addressesProduced(9) === DbAddress("GB10091472481", List("Unit 1", "25 Manor Road"), Some("Exeter"), "EX4 1BU", Some("GB-ENG"), None))
      ...
      assert(addressesProduced(10) === DbAddress("GB10091471884", List("Room 4 Baring House", "6 Baring Crescent"), Some("Exeter"), "EX1 1TL", Some("GB-ENG"), None))
      ...
      assert(addressesProduced(16) === DbAddress("GB10091471886", List("Office 7 Baring House", "6 Baring Crescent"), Some("Exeter"), "EX1 1TL", Some("GB-ENG"), None))
      ...
      assert(addressesProduced(20) === DbAddress("GB10023117655", List("School Kitchen St Michaels Ce Primary School", "South Lawn Terrace"), Some("Exeter"), "EX1 2SN", Some("GB-ENG"), None))
      ...
      assert(addressesProduced(21) === DbAddress("GB10023119039", List("Annexe" , "12 St Leonards Road"), Some("Exeter"), "EX2 4LA", Some("GB-ENG"), None))
    }
  }
