...
class ExtractorTest extends FunSuite with Matchers with MockitoSugar {
  ...
  test(
    ...
    assert(logger.infos.map(_.message) === List(
      ...
      "Info:First pass obtained 5 BLPUs, 0 DPA UPRNs, 1683 streets",
    ...
    assert(addressesProduced(8) === DbAddress("GB10023117082", List("1 Rivermead Road"), "Exeter", "EX2 4RH"))
    ...
    assert(addressesProduced(14) === DbAddress("GB10023117050", List("Beech Cottage", "Beech Avenue"), "Exeter", "EX4 6HE"))
    ...
    assert(addressesProduced(26) === DbAddress("GB10023118022", List("Annexe", "49 Wonford Road"), "Exeter", "EX2 4UD"))
    ...
    assert(addressesProduced(28) === DbAddress("GB10023117085", List("Ground Floor Front", "28 Richmond Road"), "Exeter", "EX4 4JF"))
  }
