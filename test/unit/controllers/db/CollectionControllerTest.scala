...
class CollectionControllerTest extends FunSuite with MockitoSugar {
  ...
  //  class Context(otherCollections: Set[IndexMetadataItem]) {
  ...
  //
  //  private def fakeIrrelevantCollection(name: String) = IndexMetadataItem(IndexName(name).get, Some(123), None, None)
  //
  //  private def fakeIncompleteCollection(name: String) = IndexMetadataItem(IndexName(name).get, Some(123), anyDate, None)
  //
  //  private def fakeCompletedCollection(name: String) = IndexMetadataItem(IndexName(name).get, Some(123), anyDate, anyDate)
  //
